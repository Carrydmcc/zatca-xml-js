...
exports.ZATCAStandardTaxInvoice = exports.ZATCAPaymentMethods = exports.ZATCAInvoiceTypes = void 0;
const parser_1 = require("../parser");
const vatCategoriesCodes_1 = require("../utils/vatCategoriesCodes");
const signing_1 = require("./signing");
const simplified_tax_invoice_template_1 = require("./templates/simplified_tax_invoice_template");
...
const standard_tax_invoice_template_1 = __importDefault(require("./templates/standard_tax_invoice_template"));
...
class ZATCAStandardTaxInvoice {
    ...
    constructor({ invoice_xml_str, props }) {
        if (invoice_xml_str) {
            ...
            this.invoice_xml = new parser_1.XMLDocument((0, standard_tax_invoice_template_1.default)(props));
            // Parsing
    ...
    getTaxCategoryCode = (exemption_reason) => {
        let returnCode = {
            code: 'VATEX-SA-OOS',
            value: 'O',
            text: exemption_reason
        }; // Services outside scope of tax / Not subject to VAT
        vatCategoriesCodes_1.codes.forEach(doc => {
    ...
    constructTaxTotal = (line_items) => {
        ...
        const addTaxSubtotal = (taxable_amount, tax_amount, tax_percent, tax_exemption_reason) => {
            cacTaxSubtotal.push({
                // BR-DEC-19
                "cbc:TaxableAmount": {
                    "@_currencyID": "SAR",
        ...
        const uniqueRecords = line_items.filter((item, index, self) => index === self.findIndex((t) => t.VAT_exemption_reason === item.VAT_exemption_reason));
...
exports.ZATCAStandardTaxInvoice = ZATCAStandardTaxInvoice;
