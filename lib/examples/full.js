...
const egs_1 = require("../zatca/egs");
const simplified_tax_invoice_template_1 = require("../zatca/templates/simplified_tax_invoice_template");
const ZATCAStandardTaxInvoice_1 = require("../zatca/ZATCAStandardTaxInvoice");
...
// Sample Invoice
const simplifiedTaxInvoice = new ZATCASimplifiedTaxInvoice_1.ZATCASimplifiedTaxInvoice(invoiceData);
const simplifiedCreditNote = new ZATCASimplifiedTaxInvoice_1.ZATCASimplifiedTaxInvoice({
    ...invoiceData,
    props: {
        ...invoiceData.props,
        cancelation: {
...
const simplifiedDebitNote = new ZATCASimplifiedTaxInvoice_1.ZATCASimplifiedTaxInvoice({
    ...invoiceData,
    props: {
        ...invoiceData.props,
        cancelation: {
...
const standardTaxInvoice = new ZATCAStandardTaxInvoice_1.ZATCAStandardTaxInvoice(invoiceData);
const standardCreditNote = new ZATCAStandardTaxInvoice_1.ZATCAStandardTaxInvoice({
    ...invoiceData,
    props: {
        ...invoiceData.props,
        cancelation: {
...
const standardDebitNote = new ZATCAStandardTaxInvoice_1.ZATCAStandardTaxInvoice({
    ...invoiceData,
    props: {
        ...invoiceData.props,
        cancelation: {
...
const onboardEgsUnit = async () => {
    // Init a new EGS
    const egs = new egs_1.EGS(egsunit, __1.ENV.SIMULATION);
